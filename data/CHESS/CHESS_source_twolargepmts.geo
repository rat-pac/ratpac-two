...
/////////////////////
{
  ...
  material: "air", //air, felt
  //  surface: "felt", //none, felt
  color: [0.5, 0.2, 0.1, 0.1],
}
...
/////////////////
{
  ...
  pmts: 2,
  cavity: true,
  rotation:  [0.0, 0.0, 146.6],
  position: [-288.0, -367.0, -220.91], //side
...

{
  ...
  mother: "inner",
  type: "box",
  size: [100.0,1.0,170.0],
  position: [-140.0, -220.0, -270.0],
...

{
   ...
   pmt_detector_type: "idpmt",
   sensitive_detector: "/mydet/pmt/inner",
   pos_table: "PMTINFO_TRIGGER_TWOLARGE",
   orientation: "point",
   orient_point: [-288.0, -367.0, -222.5],
}

{
   ...
   pmt_detector_type: "idpmt",
   sensitive_detector: "/mydet/pmt/inner",
   pos_table: "PMTINFO_COTRIGGER_TWOLARGE",
   orientation: "point",
   orient_point: [-288.0, -367.0, -222.5],
}
