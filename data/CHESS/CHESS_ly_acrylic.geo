...

{
  ...
  mother: "inner",
  type: "box",
  size: [13.0,13.0,38.0], //mm, half-lenght
  position: [138.7, 0.2, -234.91], //114.3mm from PMT
  rotation:  [0.0, 0.0, -124.4],
  material: "chsrc_uva_acrylic",
  surface: "chsrc_uva_acrylic",
  color: [0.0, 0.0, 0.0, 0.1],
}
...
//TOP
{
  ...
  mother: "inner",
  type: "tube",
  position: [151.6, 9.0, -250.91], //1inch from vessel
//  rotation:  [-34.4, -34.4, 0.0],
  orientation:  [-0.82531, -0.564679, 0.0],
  r_max: 12.808,
