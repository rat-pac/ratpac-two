...

{
  ...
  material: "air",
//  position: [200.0, 0.0, 0.0], //10cm from PMT
...

{
  ...
  position: [500.0, 560.0, -150.0], //10cm from PMT
...

{
  ...
  position: [500.0, 560.0, -126.5], //10cm from PMT
  rotation:  [0.0, 0.0, -90.0],
...

{
  ...
  mother: "inner",
  type: "box",
  size: [13.0,13.0,0.1], //mm, half-lenght
  position: [500.0, 560.0, -172.6], //114.3mm from PMT
...

{
  ...
  mother: "mask",
  type: "box",
  size: [6.25,6.25,0.1], //mm, half-lenght
...
//TOP
{
  ...
  mother: "inner",
  type: "tube",
  position: [509.17, 560.0, -147.7], //1inch from vessel
  rotation:  [0.0, 90.0, 0.0],
//  orientation:  [-1.0, 0.01, 0.0],
  r_max: 12.808,
...

{
   ...
   pmt_detector_type: "idpmt",
   sensitive_detector: "/mydet/pmt/inner",
   pos_table: "PMTINFO_TRIGGER_LY_TIME",
   orientation: "manual",
}
