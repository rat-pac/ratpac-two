...
double AdaptiveSimpsonQuadrature::Integrate(Evaluateable& f,
...
double AdaptiveSimpsonQuadrature::evaluate(Evaluateable& f,
...
double AdaptiveSimpsonQuadrature::refine(Evaluateable& f, double whole,
                                         double xlo, double flo,
                                         double xmd, double fmd,
                                         double xhi, double fhi){
    double rv;
