...
public:
  PMTConcentrator(const G4String &name, double upper_radius,
                  double lower_radius,
                  double a, // SEE Mike Lay's Thesis
                  double b, double d, G4Material *outerMaterial,
                  G4Material *bulkMaterial, G4OpticalSurface *reflective_surf);
  double GetHeight();
  void SetInvisible();
