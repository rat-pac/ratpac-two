...
G4LogicalVolume *WaterBoxConstruction::ConstructLogicalVolume(DBLinkPtr table) {
  ...
  G4Box *thebox =
      new G4Box("waterbox_box", size[0] / 2, size[1] / 2, size[2] / 2);
  ...
  G4Box *airbox = new G4Box("waterbox_air", size[0] / 2 - thickness,
                            size[1] / 2 - thickness, size[2] / 2 - thickness);
  ...
  G4Box *water_boxpart =
      new G4Box("water_boxpart", size[0] / 2 - thickness,
                size[1] / 2 - thickness, size[2] / 2 - thickness);
  ...
  G4IntersectionSolid *water_sol = new G4IntersectionSolid(
      "waterbox_water", water_boxpart, water_spherepart);
