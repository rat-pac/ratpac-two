...
#include <RAT/GeoBoxFactory_sub_tube.hh>

namespace RAT {

G4VSolid *GeoBoxFactory_sub_tube::ConstructSolid(DBLinkPtr table) {
  ...
  return new G4SubtractionSolid(volume_name, box, cyl, 0, Rel_Trans);
}
