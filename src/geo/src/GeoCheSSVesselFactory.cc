...
G4VSolid *GeoCheSSVesselFactory::ConstructSolid(DBLinkPtr table)
{
  ...
  if(pmts==0) unionVolume0 = new G4UnionSolid("union0", firstVolume, flat, *transf);
  else if(pmts==1) unionVolume0 = new G4UnionSolid("union0", firstVolume, flat_pmt, *transf);
  else if(pmts==2) unionVolume0 = new G4UnionSolid("union0", firstVolume, flat, *transf);
  else{
  ...
  if(pmts==0) finalVolume = new G4UnionSolid(volume_name, unionVolume0, flat, *transf);
  else finalVolume = new G4UnionSolid(volume_name, unionVolume0, flat, *transf);
