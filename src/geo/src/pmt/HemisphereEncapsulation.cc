...
G4LogicalVolume *HemisphereEncapsulation::BuildVolume(const std::string &prefix) {
  ...
  G4LogicalVolume *envelope_log = 0, *front_encapsulation_log, *rear_encapsulation_log, *metal_flange_encapsulation_log;
  G4LogicalVolume *inner_encapsulation_log = 0, *optical_gel_encapsulation_log, *silica_bag_encapsulation_log,
