...
PMTConcentrator::PMTConcentrator(const G4String &name, G4double _upper_radius, G4double _lower_radius,
        ...
        G4OpticalSurface *reflective_surf) : G4LogicalVolume(new G4Box("temp", 10, 10, 10), bulkMaterial, name) {
    this->a = _a;
    this->b = _b;
    this->d = _d;
    ...
    // surface in between
    G4Polycone *conc_solid = new G4Polycone(name + "_plastic", 0, CLHEP::twopi, n, z, r_oil_plastic_boundary, r_outer_plastic);
