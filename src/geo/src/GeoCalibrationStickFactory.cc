...
G4VPhysicalVolume* GeoCalibrationStickFactory::Construct(DBLinkPtr table) {
    ...
    G4Tubs* stickSolid = new G4Tubs("CalibrationStick_StickSolid", innerDiameter/2.0, outerDiameter/2.0, stickLength/2.0, 0, twopi);
    ...
    G4Tubs* bottomSolid = new G4Tubs("CalibrationStick_BottomSolid", 0, outerDiameter/2.0, bottomThickness/2.0, 0, twopi);
    ...
    G4Tubs* sourceSolid = new G4Tubs("CalibrationStick_SourceSolid", 0, innerDiameter/2.0, sourceThickness/2.0, 0, twopi);
    ...
    G4VPhysicalVolume* stickPhys = new G4PVPlacement(rotation, position, "CalibrationStick_Stick", 
        stickLog, motherPhys, false, 0);
    G4VPhysicalVolume* bottomPhys = new G4PVPlacement(rotation, position - G4ThreeVector(0, 0, (stickLength + bottomThickness)/2.0),
        "CalibrationStick_Bottom", bottomLog, motherPhys, false, 0);
    G4VPhysicalVolume* sourcePhys = new G4PVPlacement(rotation, position - G4ThreeVector(0, 0, (stickLength/2.0)-sourcePosition),
        "CalibrationStick_Source", sourceLog, motherPhys, false, 0);
    G4VPhysicalVolume* gasPhys = new G4PVPlacement(rotation, position, "CalibrationStick_Gas", 
        gasLog, motherPhys, false, 0);
