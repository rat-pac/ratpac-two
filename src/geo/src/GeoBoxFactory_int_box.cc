...
#include <RAT/GeoBoxFactory_int_box.hh>

namespace RAT {

G4VSolid *GeoBoxFactory_int_box::ConstructSolid(DBLinkPtr table) {
  ...
  return new G4IntersectionSolid(volume_name, box, other_box, 0, Rel_Trans);
}
}  // namespace RAT
