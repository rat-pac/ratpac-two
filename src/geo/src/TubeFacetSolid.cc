...
G4VSolid *MakeFacetSolid(const G4String &pName, std::vector<G4TwoVector> polygon, G4double scale, G4double hz,
                         G4double angle, G4VSolid *basesolid) {
  G4int Nfac = polygon.size();
  G4double poly_max = 0.0 * CLHEP::mm;
  G4double poly_max_tmp = 0.0 * CLHEP::mm;
  for (G4int i = 0; i < Nfac; i++) {
    poly_max_tmp = sqrt((polygon[i].x() * CLHEP::mm * polygon[i].x() * CLHEP::mm) +
                        (polygon[i].y() * CLHEP::mm * polygon[i].y() * CLHEP::mm));
...
G4VSolid *MakeFacetSphereSolid(const G4String &pName, std::vector<G4TwoVector> polygon, std::vector<G4double> angles,
                               G4double OR, G4VSolid *basesolid) {
...
G4VSolid *MakeTubeFacetSolid(const G4String &pName, std::vector<G4TwoVector> polygon, G4double scale, G4double hz,
                             G4double angle, G4double r_min, G4double r_max) {
...
G4VSolid *MakeTubeFacetSolid(const G4String &pName, std::vector<G4TwoVector> polygon, G4double scale, G4double hz,
                             G4double angle, G4double r_max) {
  return MakeTubeFacetSolid(pName, polygon, scale, hz, angle, 0, r_max);
}

G4VSolid *MakeConeFacetSolid(const G4String &pName, std::vector<G4TwoVector> polygon, G4double scale, G4double hz,
                             G4double angle, G4double r_min_1, G4double r_max_1, G4double r_min_2, G4double r_max_2) {
...
G4VSolid *MakeConeFacetSolid(const G4String &pName, std::vector<G4TwoVector> polygon, G4double scale, G4double hz,
                             G4double angle, G4double r_max_1, G4double r_max_2) {
  return MakeConeFacetSolid(pName, polygon, scale, hz, angle, 0, r_max_1, 0, r_max_2);
}

G4VSolid *MakeShellFacetSolid(const G4String &pName, std::vector<G4TwoVector> polygon, std::vector<G4double> angles,
                              G4double IR, G4double OR, G4double dTheta) {
...
G4VSolid *MakeSphereFacetSolid(const G4String &pName, std::vector<G4TwoVector> polygon, std::vector<G4double> angles,
                               G4double OR, G4double dTheta) {
