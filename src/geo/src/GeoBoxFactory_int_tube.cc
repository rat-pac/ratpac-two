...
#include <RAT/GeoBoxFactory_int_tube.hh>

namespace RAT {

G4VSolid *GeoBoxFactory_int_tube::ConstructSolid(DBLinkPtr table) {
  ...
  return new G4IntersectionSolid(volume_name, box, cyl, 0, Rel_Trans);
}
