...
#include <RAT/GeoTubeFactory_int_tube.hh>

namespace RAT {

G4VSolid *GeoTubeFactory_int_tube::ConstructSolid(DBLinkPtr table) {
  ...
  return new G4IntersectionSolid(volume_name, cyl, other_cyl, 0, Rel_Trans);
}
