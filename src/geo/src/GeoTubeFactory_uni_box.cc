...
#include <RAT/GeoTubeFactory_uni_box.hh>

namespace RAT {

G4VSolid *GeoTubeFactory_uni_box::ConstructSolid(DBLinkPtr table) {
  ...
  return new G4UnionSolid(volume_name, cyl, box, 0, Rel_Trans);
}
