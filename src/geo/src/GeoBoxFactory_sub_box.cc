...
#include <RAT/GeoBoxFactory_sub_box.hh>

namespace RAT {

G4VSolid *GeoBoxFactory_sub_box::ConstructSolid(DBLinkPtr table) {
  ...
  return new G4SubtractionSolid(volume_name, box, other_box, 0, Rel_Trans);
}
}  // namespace RAT
