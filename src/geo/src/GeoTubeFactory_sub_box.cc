...
#include <RAT/GeoTubeFactory_sub_box.hh>

namespace RAT {

G4VSolid *GeoTubeFactory_sub_box::ConstructSolid(DBLinkPtr table) {
  ...
  return new G4SubtractionSolid(volume_name, cyl, box, 0, Rel_Trans);
}
