...
#include <RAT/GeoTubeFactory_sub_tube.hh>

namespace RAT {

G4VSolid *GeoTubeFactory_sub_tube::ConstructSolid(DBLinkPtr table) {
  ...
  return new G4SubtractionSolid(volume_name, cyl, other_cyl, 0, Rel_Trans);
}
