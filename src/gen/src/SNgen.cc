...
//       if (model == 0) {
//	  TFile *IBD_fe = new TFile("/Users/bergevin1/software/rat-pac/data/nu_e_data_1_313.root");
//	  TF1 *glum_e = (TF1*)IBD_fe->Get("f1");
//	  TF1 *gmene_e = (TF1*)IBD_fe->Get("f3");
//	  TF1 *galpha_e = (TF1*)IBD_fe->Get("f2");
//	  TFile *IBD_feb = new TFile("/Users/bergevin1/software/rat-pac/data/nu_eb_data_1_3.root");
//	  TF1 *glum_eb = (TF1*)IBD_feb->Get("f1");
//	  TF1 *gmene_eb = (TF1*)IBD_feb->Get("f3");
//	  TF1 *galpha_eb = (TF1*)IBD_feb->Get("f2");
//	  TFile *IBD_fx = new TFile("/Users/bergevin1/software/rat-pac/data/nu_x_data_1_3.root");
//	  TF1 *glum_x = (TF1*)IBD_fx->Get("f1");
//	  TF1 *gmene_x = (TF1*)IBD_fx->Get("f3");
//	  TF1 *galpha_x = (TF1*)IBD_fx->Get("f2");
//        }
...
namespace RAT {
  ...
  // Reactions Generator, Modified by Will
	...
	Double_t m_n;
       	m_n = 939.57;
      // Calculate Flux & XS
	TF1 *IBD_Flux = new TF1("IBD_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",1.806,100);
	IBD_Flux->SetParameters(alran_IBD,meran_IBD);
       	TF1 *IBD_XS = new TF1("IBD_XS","((([0]*[1]*[2]*((1+3*([3]*[3]))/4)*(TMath::Power(((x-[4])/[5]),2))*sqrt(1-(([5]/(x-[4]))*([5]/(x-[4]))))*(1+((1.1*x/[6]))))))",1.806,100);
    ...
    double SNgen::GetESRandomEnergy(Double_t &dt){
      // Here, a random number is chosen to select e, eb or and then it is similar to IBD above
       ...
       if ( ran_ES <= 0.167 ){
	    ...
	    sin_wei_ESe = 1.29332;
	    TF1 *ES_e_Flux = new TF1("ES_e_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",0,100);
       ...
       if ( 0.167 < ran_ES && ran_ES <= 0.33 ){
	    ...
	    TF1 *ES_eb_Flux = new TF1("ES_eb_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",0,100);
       ...
       if ( ran_ES > 0.33 ){
	    ...
	    sin_wei_ESx = 1.29332;
	    TF1 *ES_x_Flux = new TF1("ES_x_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",0,100);
    ...
    double SNgen::GetCCRandomEnergy(Double_t &dt){
	    ...
	    dt = ran_CC;
            ...
            TF1 *CC_Flux = new TF1("CC_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",0,100);
    ...
    double SNgen::GetICCRandomEnergy(Double_t &dt){
	    ...
	    dt = ran_ICC;
            ...
            TF1 *ICC_Flux = new TF1("ICC_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",0,100);
  ...
  double SNgen::GetNCRandomEnergy(Double_t &dt){ //
	    ...
	    dt = ran_NC;
            ...
            TF1 *NC_Flux = new TF1("NC_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",0,100);
    ...
    double SNgen::GetNCRandomNuEnergy(){
	    ...
	    // dt = ran_NCR; // NC Nu is different to the others
            ...
            TF1 *NCR_Flux = new TF1("NCR_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",0,100);
    ...
    double SNgen::GetINCRandomEnergy(Double_t &dt){
	    ...
	    dt = ran_INC;
            ...
            TF1 *INC_Flux = new TF1("INC_Flux","(TMath::Power(x,[0]))/(TMath::Gamma([0]+1))*TMath::Power(([0]+1)/[1],[0]+1)*exp(-(([0]+1)/[1])*x)",0,100);
