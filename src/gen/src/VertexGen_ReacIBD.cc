...
void VertexGen_ReacIBD::SetState(G4String newValues) {
  ...
  if (newValues.length() == 0) {
    ...
    info << "Current state of this VertexGen_ReacIBD:" << newline << " \"" << GetState() << "\"" << newline << newline;
    info << "Format of argument to VertexGen_ReacIBD::SetState: " << newline << " \"nu_dir_x nu_dir_y nu_dir_z\"\n"
