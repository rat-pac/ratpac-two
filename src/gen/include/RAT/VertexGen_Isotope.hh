 ...
 *
 * Vertex Generator - events of given particle (or ion) type, with energies
 * sampled from Isotope via DB
 *
 * @author Jeanne Wilson <j.wilson2@physics.ox.ac.uk>
 *
 * first version : 18-July-2008
 *
 * This vertex generator (to be used in composite generators like combo of
 * coincidence) produces isotropic particles or ions with kinetic energies
 * sampled from a data-base defined distribution. An option to limit the range
...
class VertexGen_Isotope : public GLG4VertexGen {
 public:
  ...
  /** Set up the Isotope array in memory - create normalised cumulative
   * magnitude for easy**/
