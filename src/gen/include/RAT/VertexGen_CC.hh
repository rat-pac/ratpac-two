...
/// The CC cross-section is now determined in a separate class. This class is responsible for performing the kinematic propagation.
///
////////////////////////////////////////////////////////////////////
...
namespace RAT {
  ...
  public:
     ...
     *
     * @param flavor Flavor key passed to the RAT::CCCrossSec class. It can be one of (<tt>nue,numu,nuebar,numubar</tt>).
     */
