 ...
 *  Generate event vertices at random points within a spherical shell and
 * contained in a specific volume.
 *
 *  Syntax: /generator/pos/set <xyz coordinates of center of spheres> <rmin>
 * <rmax> <volume name>
 */
