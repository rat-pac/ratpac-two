...
public:
  ...
  virtual void GenerateIBDVertex(G4Event *argEvent, G4ThreeVector &dx,
                                 G4double dt, G4double e_nu);

  virtual void GenerateESVertex(G4Event *argEvent, G4ThreeVector &dx,
                                G4double dt, G4double e_nu);

  virtual void GenerateCCVertex(G4Event *argEvent, G4ThreeVector &dx,
                                G4double dt, G4double e_nu);

  virtual void GenerateICCVertex(G4Event *argEvent, G4ThreeVector &dx,
                                 G4double dt, G4double e_nu);

  virtual void GenerateNCVertex(G4Event *argEvent, G4ThreeVector &dx,
                                G4double dt, G4double e_nu);

  virtual void GenerateINCVertex(G4Event *argEvent, G4ThreeVector &dx,
                                 G4double dt, G4double e_nu);

  virtual CLHEP::HepLorentzVector
  GetEmomentum(G4double e_nu, G4double eelectron, G4ThreeVector neutrino_dir);
  ...
  static double FindCosTheta(G4double Enu, G4double target_mass_c2,
