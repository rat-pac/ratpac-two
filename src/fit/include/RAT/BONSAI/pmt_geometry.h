...
class pmt_geometry {
 ...
 public:
  ...
  inline int npmts(void) { return (npmt); }
  ...
  inline float cylinder_radius(void) { return (rmax); }
  inline float cylinder_height(void) { return (zmax); }
  inline float cylinder_diagonal(void) { return (2 * sqrt(rmax * rmax + zmax * zmax)); }
  inline float cylinder_circonference(void) { return (2 * (rmax + zmax)); }
};
#endif
