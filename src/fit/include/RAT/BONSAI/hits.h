...
class hits {
 ...
 public:
  hits(int ns, float *set, float *pmt_loc, int *bad_ch, int n_raw, int *cable, float *tim_raw, float *chg_raw);
  ...
  inline static float NS_TO_CM;
  inline static float CM_TO_NS;
  inline static float CM_TO_NS2;
...
#include <RAT/BONSAI/hits.inline>
#endif
