...
class fitquality {
 ...
 protected:
  ...
  // *************************************************************
  inline void set_worst(float q) { worst = q; };
  // *************************************************************
  ...
  inline void reset_fits(void) { qualities.clear(); };
  // *************************************************************
 ...
 public:
  ...
  inline virtual float quality(float *v) { return (-1e20); };
  inline virtual void check_around(float *vertex, float *result, float radius, float *q, int &max) {
    max = -1;
    return;
  };
  inline virtual char ncheck(void) { return (0); }
