...
G4_DECLARE_PHYSCONSTR_FACTORY(MyG4HadronPhysicsShielding);

MyG4HadronPhysicsShielding::MyG4HadronPhysicsShielding(G4int verb) : MyG4HadronPhysicsShielding() {
  G4HadronicParameters::Instance()->SetVerboseLevel(verb);
}

MyG4HadronPhysicsShielding::MyG4HadronPhysicsShielding(const G4String& name)
    : MyG4HadronPhysicsShielding(name, false) {}

MyG4HadronPhysicsShielding::MyG4HadronPhysicsShielding(const G4String& name, G4bool qe)
    : G4HadronPhysicsFTFP_BERT(name, qe), useLEND_(false), evaluation_("") {
  minBERT_neutron = 19.9 * CLHEP::MeV;
}

MyG4HadronPhysicsShielding::MyG4HadronPhysicsShielding(const G4String& name, G4int verb)
    : MyG4HadronPhysicsShielding(name, false) {
  G4HadronicParameters::Instance()->SetVerboseLevel(verb);
}

MyG4HadronPhysicsShielding::MyG4HadronPhysicsShielding(const G4String& name, G4int verb, G4double minFTFPEnergy,
...
MyG4HadronPhysicsShielding::~MyG4HadronPhysicsShielding() {}

void MyG4HadronPhysicsShielding::Neutron() {
  ...
  if (useLEND_) {
    ...
    auto hpneu = new MyG4NeutronPHPBuilder;
    AddBuilder(hpneu);
    neu->RegisterMe(hpneu);
  }
  neu->Build();
...
void MyG4HadronPhysicsShielding::ConstructProcess() {
