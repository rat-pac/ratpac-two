...
#ifndef nRangeG4Cerenkov_h
#define nRangeG4Cerenkov_h 1
...
class nRangeG4Cerenkov : public G4VProcess {
 public:
  explicit nRangeG4Cerenkov(const G4String& processName = "nRangeG4Cerenkov", G4ProcessType type = fElectromagnetic);
  ~nRangeG4Cerenkov();

  explicit nRangeG4Cerenkov(const nRangeG4Cerenkov& right);

  nRangeG4Cerenkov& operator=(const nRangeG4Cerenkov& right) = delete;
...
inline G4bool nRangeG4Cerenkov::GetTrackSecondariesFirst() const { return fTrackSecondariesFirst; }

inline G4double nRangeG4Cerenkov::GetMaxBetaChangePerStep() const { return fMaxBetaChange; }

inline G4int nRangeG4Cerenkov::GetMaxNumPhotonsPerStep() const { return fMaxPhotons; }

inline G4bool nRangeG4Cerenkov::GetStackPhotons() const { return fStackingFlag; }

inline G4int nRangeG4Cerenkov::GetNumPhotons() const { return fNumPhotons; }

inline G4PhysicsTable* nRangeG4Cerenkov::GetPhysicsTable() const { return thePhysicsTable; }

#endif /* nRangeG4Cerenkov_h */
