...
#ifndef __RAT_G4CerenkovProcess_h
#define __RAT_G4CerenkovProcess_h 1
...
class G4CerenkovProcess : public G4VProcess {
 public:
  ...
  explicit G4CerenkovProcess(const G4CerenkovProcess& right);
...
inline G4bool G4CerenkovProcess::GetTrackSecondariesFirst() const { return fTrackSecondariesFirst; }

inline G4double G4CerenkovProcess::GetMaxBetaChangePerStep() const { return fMaxBetaChange; }

inline G4int G4CerenkovProcess::GetMaxNumPhotonsPerStep() const { return fMaxPhotons; }

inline G4bool G4CerenkovProcess::GetStackPhotons() const { return fStackingFlag; }
