...
public:
  ...
  virtual void SetPulseWidth(double _fPulseWidth) {
    fPulseWidth = _fPulseWidth;
  };
  virtual void SetPulseOffset(double _fPulseOffset) {
    fPulseOffset = _fPulseOffset;
  };
  virtual void SetPulseTimeOffset(double _fPulseTimeOffset) {
    fPulseTimeOffset = _fPulseTimeOffset;
  };
