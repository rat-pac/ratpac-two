...
ClassImp(RAT::WaveformAnalysis)
  ...
  double WaveformAnalysis::CalculatePedestal(
      std::vector<UShort_t> wfm, UShort_t low_window, UShort_t high_window) {
    /*
  ...
  double WaveformAnalysis::CalculateTime(
      std::vector<UShort_t> wfm, UShort_t low_window, UShort_t high_window,
      double dy, double sampling_rate, double cfd_fraction, UShort_t lookback) {
    /*
