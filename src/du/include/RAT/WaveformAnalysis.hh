...
class WaveformAnalysis : public TObject {
 public:
  ...
  UShort_t GetThresholdCrossing(std::vector<UShort_t> wfm, double dy, double pedestal, double peak,
                                UShort_t peak_sample, double cfd_fraction = 0.60, UShort_t lookback = 30);
