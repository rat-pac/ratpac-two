...
ReacIBDgenMessenger::ReacIBDgenMessenger(ReacIBDgen *re) : reacibdgen(re) {
  ...
  dir->SetGuidance(
      "Control the reactor isotope contents of the Reactor IBD generator");

  U235AmpCmd = new G4UIcmdWithADouble("/generator/reacibd/U235", this);
  U235AmpCmd->SetGuidance(
      "Sets the fractional amount of U235 in the reactor of interest");
  ...
  U238AmpCmd->SetGuidance(
      "Sets the fractional amount of U238 in the reactor of interest");
  ...
  Pu239AmpCmd->SetGuidance(
      "Sets the fractional amount of Pu239 in the reactor of interest");
  ...
  Pu241AmpCmd->SetGuidance(
      "Sets the fractional amount of Pu241 in the reactor of interest");
