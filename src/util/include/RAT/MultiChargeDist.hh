...
/** Generates the normalized n-photoelectron charge distributions
    ...
    maxPE: Generate n-photoelectron charge distributions from 0 to maxPE
   (inclusive) qMaxStepSize: Compute distribution with at most this  step size
   in charge units qBins: compute the distribution with this many bins unless
   the step size is too larg
